...
function TasksPage() {
  ...
  this.emailAddressTextBox = element(by.id('email_create'));
  this.createAccountButton = element(by.id('SubmitCreate'));
  this.ErrorLabel = element(by.id('create_account_error'));
   ...
   */
   ...
   this.emailBlank = () => {
    //this.emailAddressTextBox.click();
  //  this.createAccountButton.click();
      actions.clickToElement(this.emailAddressTextBox);
      actions.clickToElement(this.createAccountButton);

  };
  this.createTask = (email) => {

    actions.enterText(this.emailAddressTextBox, email);
    actions.clickToElement(this.createAccountButton);
  };

  // this.emailReal = () => {
  //   //this.emailAddressTextBox.click();
  //   this.emailAddressTextBox.sendKeys('mmar@gmail.com');
  //   this.createAccountButton.click();
  // };
  ...
  this.isAgendaViewDisplayed = () => {
    return actions.isElementDisplayed(this.emailAddressTextBox);
  };
  this.isErrorMessageDisplayed = () => {
    return actions.isElementDisplayed(this.ErrorLabel);
  };
